...
export default function MessageInput({ onSend }) {
  ...
  return (
    <div className="border-t border-slate-100 bg-white px-3 py-2 sm:px-4 sm:py-3">
      {errorMsg && (
        <div className="mb-2 rounded-lg bg-red-50 p-2 text-xs font-medium text-red-600">
          {errorMsg}
        </div>
      )}
